  ...
  <div class="container mx-auto">
    <div class="-mx-4 flex flex-wrap">
      ...
      <div class="w-full px-4 sm:w-1/2 lg:w-2/12">
        <div class="mb-10 w-full">
          <h4 class="text-dark mb-9 text-lg font-semibold">{t('Resources')}</h4>
          <ul>
            <li>
              <a
      ...
      <div class="w-full px-4 sm:w-1/2 lg:w-2/12">
        <div class="mb-10 w-full">
          <h4 class="text-dark mb-9 text-lg font-semibold">{t('Company')}</h4>
          <ul>
            <li>
              <a
                href="javascript:void(0)"
      ...
      <div class="w-full px-4 sm:w-1/2 lg:w-2/12">
        <div class="mb-10 w-full">
          <h4 class="text-dark mb-9 text-lg font-semibold">{t('Quick Links')}</h4>
          <ul>
            <li>
              <a
                href="javascript:void(0)"
      ...
      <div class="w-full px-4 sm:w-1/2 lg:w-3/12">
        <div class="mb-10 w-full">
          <h4 class="text-dark mb-9 text-lg font-semibold">{t('Follow Us On')}</h4>
          ...
          <p class="text-body-color text-base">&copy; {currentYear} DoggyProject</p>
        </div>
      </div>
    </div>
  </div>

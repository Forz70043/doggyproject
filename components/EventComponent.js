    ...
    return (
        ...
        <div className="bg-white dark:bg-slate-800 py-24 sm:py-32 flex flex-col items-center">
            {events.map((elem, index) => {
                return (
                    <a key={index} href="#" className="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 my-3">

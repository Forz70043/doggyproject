        ...
        <>
            <div className="bg-white dark:bg-slate-800 py-24 sm:py-32">
                <div className="mx-auto grid max-w-7xl gap-y-20 gap-x-8 px-6 lg:px-8 xl:grid-cols-3">
                    ...
                    <ul role="list" className="grid sm:grid-cols-2 sm:gap-y-16 xl:col-span-2">
                            ...
                            return(
                                <li key={index}>
                                    <div className="flex items-center gap-x-6">
                                        ...
                                        <div>
                                            <h3 className="text-base font-semibold leading-7 tracking-tight text-gray-900 dark:text-white">{elem.aka}</h3>
                                            <p className="text-sm font-semibold leading-6 dark:text-slate-400 text-indigo-600">{elem.description}</p>
                                        </div>
                                    </div>
                                </li>
                            )
